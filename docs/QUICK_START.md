...
| File | Purpose |
|------|---------|
| `scripts/main.py` | Full simulation with GUI visualization |
| `scripts/test_simulation.py` | Quick test without GUI (for debugging) |
| `scripts/animate_swarm.py` | Live animation of swarm movement |
| `scripts/save_animation.py` | Save simulation as video |
...
The `scripts/test_simulation.py` script doesn't need display and works everywhere.
...
**Next: Run** `python scripts/test_simulation.py` **to see it in action!**
